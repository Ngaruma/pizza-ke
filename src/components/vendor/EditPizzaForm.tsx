...
export const EditPizzaForm: React.FC<EditPizzaFormProps> = ({ pizza, onClose }) => {
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-2">
            <Button
              type="submit"
              disabled={updatePizza.isPending}
              className="bg-orange-600 hover:bg-orange-700"
            >
              {updatePizza.isPending ? 'Updating...' : 'Update Pizza'}
            </Button>
